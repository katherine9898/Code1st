    ...
    public partial class M1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Celtics", "Boston", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Golden State Warriors", "Oakland", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Lakers", "Los Angeles", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Pelicans", "New Orleans", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Raptors", "Toronto", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Rockets", "Houston", null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "TeamName", "City", "Manager" },
                values: new object[] { "Thunder", "Oklahoma City", null });
